...
', 'novellite' ), $theme_data->get( 'Name' )),
        'tab_one' =>esc_html__( 'Getting Started', 'novellite' ),
        ...
        'docs_title' => esc_html__( 'Step 1 - Check Theme Documentation', 'novellite' ),
        'docs_link' => 'https://www.themehunk.com/docs/novellite-theme/',
        'docs_text' => sprintf(esc_html__('Need any help to setup home-page and configure %s ? Please have a look at our documentation.', 'novellite'), $theme_data->get( 'Name' )),
        'docs_button' => esc_html__('Documentation', 'novellite'),
		
		'customizer_title' => esc_html__( 'Step 2 - Theme Customizer', 'novellite' ),
        ...
        'customizer_button' => sprintf( esc_html__('Start Customize', 'novellite')),
         'plugin_title' => esc_html__( 'Step 3 - Do Recommended Actions', 'novellite' ),
        'plugin_link' => '?page=th_novellite&tab=actions_required',
        'plugin_text' => sprintf(esc_html__('To set up contact section. You have to install recommended plugin.', 'novellite'), $theme_data->get( 'Name' )),
        'plugin_button' => esc_html__('Go To Recommended Action', 'novellite'),


        'support_title' => esc_html__( 'Step 4 - Contact Support Forum, if you need help', 'novellite' ),
...
function NovelLite_tab() {
               $number_count = online_lite_count_active_plugins();
               $menu_title = esc_html__('NovelLite', 'novellite');
           if( $number_count >0):
           $count = "<span class='update-plugins count-".esc_attr( $number_count )."' title='".esc_attr( $number_count )."'><span class='update-count'>" . number_format_i18n($number_count) . "</span></span>";
               $menu_title = sprintf( esc_html__('About NovelLite %s', 'novellite'), $count );
           endif;
...
<p>
 <a href="https://www.themehunk.com/product/novellite-one-page-wordpress-theme/" target="_blank" class="button button-primary"><?php _e('Check Pro version for more features','novellite'); ?></a>
                           </p></div>
<?php }
...
$child_slugs = array('novelgreen','novelpink','novelblue','blacky','coffeecafe','novellaw','doctorsline');
$child = '';
