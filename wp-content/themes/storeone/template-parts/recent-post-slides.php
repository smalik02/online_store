	...
	while($rp_query->have_posts()){
		...
		<div class="owl-slide">
            ...
            <div class="carousel-caption">
				...
				<?php if (!empty(get_theme_mod('storeone_blog_slide_button_link'))): ?>
				<a href="<?php echo esc_url(get_theme_mod('storeone_blog_slide_button_link')); ?>" class="btn banner-link animation animated-item-3"> <?php echo esc_html(get_theme_mod('storeone_blog_slide_button_text')); ?> </a>
				<?php endif; ?>
			</div>
		</div>
		<?php
